...
?>
<form action="<?php echo JRoute::_('index.php?option=com_games&view=games&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		...
		<?php foreach ($this->items as $i => $item) : ?>
			<tr class="row<?php echo $i % 2; ?>">
				<td>
					<a href="#" class="select_game" rel="<?php echo (int) $item->id; ?>">
