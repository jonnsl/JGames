 ...
 *
 */
class GamesViewAchievements extends JView
{
	protected $item;
	protected $state;
	...
	public function display($tpl = null)
	{
		...
		$pathway->addItem($this->item->title, 'index.php?option=com_games&view=game&id='.$this->item->id.($this->state->get('filter.platform', 0) ? '&platform='.$this->state->get('filter.platform', 0): ''));
		$pathway->addItem('Achievements', 'index.php?option=com_games&view=achievements&id='.$this->item->id.'&platform='.$this->state->get('filter.platform', 0));
