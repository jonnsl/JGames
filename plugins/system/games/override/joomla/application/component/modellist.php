...
class JModelList extends JModel
{
	...
	private function _getListQuery()
	{
		...
		JPluginHelper::importPlugin(str_replace('com_', '', $this->option));
		
		JDispatcher::getInstance()->trigger('on'.ucfirst(str_replace('com_', '', $this->option)).'GetQuery', array($this->query));
	...
	protected function getStoreId($id = '')
	{
		...
		JDispatcher::getInstance()->trigger('on'.ucfirst(str_replace('com_', '', $this->option)).'GetStoreId', array($id));
